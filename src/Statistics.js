...
function Statistics() {
  ...
  const [year2023, set2023] = useState({ cadt118yr23: 0, cadt135yr23: 0, cadt252yr23: 0 });
  const [year2024, set2024] = useState({ cadt118yr24: 0, cadt135yr24: 0, cadt252yr24: 0 });
  ...
  const quarterlyData118 = {
    ...
    datasets: [{
      ...
      data: [cadt118.cadtChildren118, cadt118.cadtYouth118, cadt118.cadtAdult118, cadt118.cadtElderly118],
  ...
  const quarterlyData135 = {
    ...
    datasets: [{
      label: 'Census Records',
      data: [cadt135.cadtChildren135, cadt135.cadtYouth135, cadt135.cadtAdult135, cadt135.cadtElderly135],
  ...
  const quarterlyData252 = {
    ...
    datasets: [{
      label: 'Census Records',
      data: [cadt252.cadtChildren252, cadt252.cadtYouth252, cadt252.cadtAdult252, cadt252.cadtElderly252],
  ...
  const fetch_data = async () => {
    try {
      ...
      console.log(data);
        ...
        setCadt118({ cadtChildren118, cadtYouth118, cadtAdult118, cadtElderly118 });

        const cadtChildren135 = data.filter(item => item.cadt === 'CADT 135' && parseInt(item.age) <= 14).length;
        ...
        setCadt135({ cadtChildren135, cadtYouth135, cadtAdult135, cadtElderly135 });
      
        const cadtChildren252 = data.filter(item => item.cadt === 'CADT 252' && parseInt(item.age) <= 14).length;
        ...
        setCadt252({ cadtChildren252, cadtYouth252, cadtAdult252, cadtElderly252 });
