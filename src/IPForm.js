...
function IPForm() {
  ...
  const handleSubmit = async () => {
    try {
      const { data, error } = await supabase.from("census_data").insert([
        {
          cadt: formData.cadt,
            ...
            <Card.Body className="text">
              <Row>
                    ...
                    {[
                      ...
                      <Col key={doc} xs={6} sm={4} md={5}>
                        <Form.Check
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "available_documents")
                          }
                ...
                <Col xs={12} md={6}>
                  ...
                  <Row>
                    {["Owned", "Rented", "Living with Parents"].map(
                      (status) => (
                  ...
                  <Row>
                    {["Light Material", "Semi Concrete", "Concrete"].map(
                      (type) => (
                        <Col key={type} xs={4}>
                          <Form.Check
                            type="radio"
              ...
              <Container className="d-flex justify-content-end mt-5">
                <Button
                  className="fw-bold w-25 login-btn"
                  variant="primary"
                  type="submit"
                >
                  Save
